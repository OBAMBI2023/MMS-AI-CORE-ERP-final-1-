...
import { A as Printer, B as Menu, E as Scissors, F as Palette, P as Pencil, Q as History, R as Minus, St as Banknote, T as Search, X as Image, _ as Sparkles, f as Trash2, g as Stamp, i as Wallet, j as Plus, k as Receipt, lt as CreditCard, n as X, q as Layers, tt as FileText, u as TriangleAlert, ut as Copy, v as Smartphone, vt as Check, z as MessageCircle } from "../_libs/lucide-react.mjs";
...
import { a as Sidebar, i as SheetTrigger, n as SheetContent, o as SidebarContent, r as SheetTitle, t as Sheet } from "./sheet-DI6aHliu.mjs";
import { t as Button } from "./button-BLZ6ednA.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { a as makeNumber, i as formatNumber, t as formatCurrency } from "./format-DujI6J5F.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/ventes-CxB1FL2n.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function SalesHistoryModal({ isOpen, onClose, onEdit }) {
	const [search, setSearch] = (0, import_react.useState)("");
	const [userId, setUserId] = (0, import_react.useState)(null);
	const [saleToDelete, setSaleToDelete] = (0, import_react.useState)(null);
	...
	const { data: sales, isLoading } = useQuery({
		...
		queryFn: async () => {
			const { data, error } = await supabase.from("ventes").select("*, vente_items(*)").order("created_at", { ascending: false });
			if (error) throw error;
			return data || [];
		}
	});
	const { role, roleId } = permissionsQuery.data || {
		permissions: [],
		role: null,
		roleId: null
	};
	...
	const filteredSales = (0, import_react.useMemo)(() => {
		if (!sales) return [];
		return sales.filter((s) => s.number.toLowerCase().includes(search.toLowerCase()) || s.client_name?.toLowerCase().includes(search.toLowerCase()));
	}, [sales, search]);
	const paginatedSales = (0, import_react.useMemo)(() => {
	...
	const handleExportPDF = () => {
		...
		doc.autoTable({
			...
			startY: y,
			didDrawPage: (data) => {
				doc.text(`Page ${data.pageNumber} / ${data.pageCount}`, pageWidth / 2, doc.internal.pageSize.getHeight() - 10, { align: "center" });
			}
		});
		doc.save("historique-ventes.pdf");
		toast.success("PDF généré");
	};
	const canPrint = (_sale) => true;
	const handlePrint = (sale) => {
		...
		doc.text("-----------------------", 10, 20);
		sale.vente_items?.forEach((item, index) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			className: "max-w-[95vw] w-full h-[90vh] flex flex-col p-6 rounded-3xl",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: "Historique des ventes" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: "Consultez, recherchez et gérez les ventes enregistrées." })] })]
				}) }),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex-1 overflow-auto border rounded-xl",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, { children: "Référence" }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, { children: "Paiement" }),
						...
						children: "Chargement..."
					}) }) : paginatedSales.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableRow, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
						colSpan: 7,
						className: "text-center",
						children: "Aucune vente trouvée"
					}) }) : paginatedSales.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
							className: "font-medium",
							children: s.number
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: new Date(s.created_at).toLocaleDateString() }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: s.client_name }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: formatCurrency(s.total) }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableCell, {
							...
							children: [canPrint(s) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "ghost",
								size: "icon",
								onClick: () => handlePrint(s),
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Printer, { className: "h-4 w-4" })
							}), canManageSales && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "ghost",
								size: "icon",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
								...
								children: [
									...
									50,
									100
								].map((size) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
									value: size,
									children: size
								}, size))
							})
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, {}), " Confirmer la suppression"]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: "Voulez-vous vraiment supprimer cette vente ?" })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
			variant: "outline",
...
function PosPage() {
	...
	const [saleToEdit, setSaleToEdit] = (0, import_react.useState)(null);
	...
	const canManageSales = usePermissions().data?.role === "Administrateur";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(History, { className: "h-3.5 w-3.5" }), " Historique"]
									})]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: cart.map((i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.li, {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: formatCurrency(i.qty * i.price)
											})]
										})]
									}, i.id))
								})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: saving ? "Enregistrement..." : `Encaisser ${formatCurrency(total)}`
								})
							]
						})
					]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SalesHistoryModal, {
				isOpen: showHistory,
			...
			!!saleToEdit && canManageSales && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LineItemsDialog, {
				headerTable: "ventes",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("table", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: ticket.items.map((i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									...
									children: formatNumber(i.qty * i.price)
								})] })] }, i.id)) })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "sep",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Sous-total" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: formatNumber(ticket.subTotal) })]
							}),
							ticket.discount > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Remise" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["-", formatNumber(ticket.discount)] })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "row total",
								style: {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "TOTAL FCFA" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: formatNumber(ticket.total) })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "row",
								style: {
