...
import { K as LoaderCircle, P as Pencil, d as Trash2, j as Plus, n as X, w as Search } from "../_libs/lucide-react.mjs";
import { t as supabase } from "./client-BN74eToN.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { n as AnimatePresence, t as motion } from "../_libs/framer-motion.mjs";
import { n as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ResourceTable-Cl1yCrMf.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var db = supabase;
function ResourceTable(props) {
	const { table, singular, plural, fields, columns, searchFields = [], orderBy, defaultValues = {}, renderActions } = props;
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [renderActions && renderActions(filtered), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [columns.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									onClick: () => {
										if (confirm(`Supprimer ce ${singular.toLowerCase()} ?`)) delMut.mutate(row.id);
									},
