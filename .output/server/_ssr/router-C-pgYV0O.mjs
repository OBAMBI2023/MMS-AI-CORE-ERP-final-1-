...
import { t as ThemeProvider } from "./theme-provider-DGWgppJh.mjs";
import { t as routePermissions } from "./route-permissions-CXKa-WJL.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
import "../_libs/jspdf-autotable.mjs";
import { n as objectType, r as stringType } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-C-pgYV0O.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
async function hasPermission(userId, permissionCode) {
	const { data: profile, error: profileError } = await supabase.from("profiles").select("role_id").eq("id", userId).single();
	if (profileError || !profile?.role_id) return false;
	const { data, error } = await supabase.from("role_permissions").select(`
      permissions(code)
    `).eq("role_id", profile.role_id).eq("permissions.code", permissionCode).not("permissions", "is", null);
	if (error || !data || data.length === 0) return false;
	return true;
}
var styles_default = "/assets/styles-DXELqSKH.css";
...
var Route$14 = createRootRouteWithContext()({
	beforeLoad: async ({ location }) => {
		...
		if (!session && location.pathname !== "/login") throw redirect({ to: "/login" });
		if (session && location.pathname !== "/login") {
			...
			if (requiredPermission) {
				...
				if (!isAuthorized) isAuthorized = await hasPermission(session.user.id, requiredPermission);
				if (!isAuthorized) {
...
function RootComponent() {
	...
	(0, import_react.useEffect)(() => {
		const { data: { subscription } } = supabase.auth.onAuthStateChange((event) => {
			if (event === "SIGNED_OUT" && window.location.pathname !== "/login") navigate({
				to: "/login",
				replace: true
			});
		});
...
var $$splitComponentImporter$13 = () => import("./ventes-CxB1FL2n.mjs");
var Route$13 = createFileRoute("/ventes")({
...
var $$splitComponentImporter$12 = () => import("./utilisateurs-DEpneLFV.mjs");
var Route$12 = createFileRoute("/utilisateurs")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./services-BTE9jS5E.mjs");
var Route$11 = createFileRoute("/services")({
	component: lazyRouteComponent($$splitComponentImporter$11, "component"),
	head: () => ({ meta: [{ title: "Produits & Services — MMS AI CORE" }, {
		name: "description",
		content: "Catalogue des services et produits."
	}] })
});
var $$splitComponentImporter$10 = () => import("./rapports-D2q9h8ep.mjs");
...
var $$splitComponentImporter$9 = () => import("./parametres-DMYukyNT.mjs");
...
var $$splitComponentImporter$8 = () => import("./login-dTicO10A.mjs");
objectType({
...
var $$splitComponentImporter$7 = () => import("./journal-BNunI-ov.mjs");
var Route$7 = createFileRoute("/journal")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./fournisseurs-C-cTrGYI.mjs");
var Route$6 = createFileRoute("/fournisseurs")({
...
var $$splitComponentImporter$5 = () => import("./devis-BpkEq5xY.mjs");
var Route$5 = createFileRoute("/devis")({
...
var $$splitComponentImporter$4 = () => import("./depenses-sKyIpVI7.mjs");
var Route$4 = createFileRoute("/depenses")({
...
var $$splitComponentImporter$3 = () => import("./clients-N5fPhL1t.mjs");
var Route$3 = createFileRoute("/clients")({
...
var $$splitComponentImporter$2 = () => import("./achats-UKba012C.mjs");
...
var $$splitComponentImporter = () => import("./routes-D4ttLket.mjs");
var Route = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var VentesRoute = Route$13.update({
	id: "/ventes",
	path: "/ventes",
	getParentRoute: () => Route$14
});
var UtilisateursRoute = Route$12.update({
	id: "/utilisateurs",
	path: "/utilisateurs",
	getParentRoute: () => Route$14
});
...
var JournalRoute = Route$7.update({
	id: "/journal",
	path: "/journal",
	getParentRoute: () => Route$14
});
var FournisseursRoute = Route$6.update({
	id: "/fournisseurs",
	path: "/fournisseurs",
	getParentRoute: () => Route$14
});
var DevisRoute = Route$5.update({
	id: "/devis",
	path: "/devis",
	getParentRoute: () => Route$14
});
var DepensesRoute = Route$4.update({
	id: "/depenses",
	path: "/depenses",
	getParentRoute: () => Route$14
});
var ClientsRoute = Route$3.update({
	id: "/clients",
	path: "/clients",
	getParentRoute: () => Route$14
});
