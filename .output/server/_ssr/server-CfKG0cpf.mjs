...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-D38mV2Vu.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D8ZGGoD1.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DyNWzgdA.mjs"),
		import("./start-CHh3VVE6.mjs"),
