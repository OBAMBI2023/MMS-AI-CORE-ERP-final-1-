...
//#region node_modules/.nitro/vite/services/ssr/assets/use-company-settings-BK0U8YkZ.js
...
function useCompanySettings() {
	...
	return {
		...
		signatureUrl: useSignedUrl(settings?.signature_url ?? null),
		cachetUrl: useSignedUrl(settings?.cachet_url ?? null),
		isLoading,
