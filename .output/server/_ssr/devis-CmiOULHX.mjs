...
import { K as LoaderCircle, P as Pencil, T as Search, f as Trash2, j as Plus, rt as FileDown } from "../_libs/lucide-react.mjs";
...
import { a as renderHeader, c as renderTable, i as renderFooter, l as renderTotals, o as renderLogo, s as renderSignatureAndStamp } from "./pdf-template-engine-BTnlALPQ.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/devis-CmiOULHX.js
...
function DevisPage() {
	...
	const del = useMutation({
		mutationFn: async (devis) => {
			const { error } = await supabase.from("devis").delete().eq("id", devis.id);
			if (error) throw error;
			return devis;
		},
		onSuccess: async (devis) => {
			if (userId) await logAction(userId, roleId, "delete", "devis", { devis_number: devis.number });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}), canCreateDevis && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										canDeleteDevis && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
