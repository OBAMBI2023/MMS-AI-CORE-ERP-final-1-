...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DyNWzgdA.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-BpzyxIsh.css";
...
var Route$13 = createRootRouteWithContext()({
	beforeLoad: async ({ location }) => {
		console.log("DEBUG: __root.tsx beforeLoad, path:", location.pathname);
		if (location.pathname === "/login") return;
		const { data: { session }, error } = await supabase.auth.getSession();
		if (error || !session) {
			console.log("DEBUG: __root.tsx no session, redirecting to /login");
...
var $$splitComponentImporter$12 = () => import("./ventes-Cmi3Ep1B.mjs");
var Route$12 = createFileRoute("/ventes")({
	beforeLoad: async ({ context }) => {
		if (!context.permissions.includes("ventes.view")) throw redirect({ to: "/" });
	},
...
var $$splitComponentImporter$11 = () => import("./services-BsZhs8PG.mjs");
...
var $$splitComponentImporter$10 = () => import("./rapports-CvptM9sT.mjs");
...
var $$splitComponentImporter$9 = () => import("./parametres-C32TPy7w.mjs");
var Route$9 = createFileRoute("/parametres")({
	beforeLoad: async ({ context }) => {
		if (!context.permissions.includes("settings.manage")) throw redirect({ to: "/" });
	},
...
var $$splitComponentImporter$8 = () => import("./login-CsiF-ulB.mjs");
...
var $$splitComponentImporter$7 = () => import("./fournisseurs-CyXiNK7d.mjs");
...
var $$splitComponentImporter$6 = () => import("./devis-DILtdimM.mjs");
...
var $$splitComponentImporter$5 = () => import("./depenses-YY1ZCyo7.mjs");
...
var $$splitComponentImporter$4 = () => import("./clients-BTuJ4L63.mjs");
var Route$4 = createFileRoute("/clients")({
	beforeLoad: ({ context }) => {
		if (!context.permissions.includes(routePermissions["/clients"])) throw redirect({ to: "/403" });
	},
...
var $$splitComponentImporter$3 = () => import("./assistant-BR2ovadh.mjs");
var Route$3 = createFileRoute("/assistant")({
	beforeLoad: ({ context }) => {
		if (!context.permissions.includes(routePermissions["/assistant"])) throw redirect({ to: "/403" });
	},
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("./achats-T7OUT5tq.mjs");
var Route$2 = createFileRoute("/achats")({
	beforeLoad: ({ context }) => {
		if (!context.permissions.includes(routePermissions["/achats"])) throw redirect({ to: "/403" });
	},
...
var $$splitComponentImporter = () => import("./routes-B1tEjYS-.mjs");
