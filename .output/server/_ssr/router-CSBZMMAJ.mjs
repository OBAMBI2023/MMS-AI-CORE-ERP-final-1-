...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CSBZMMAJ.js
...
var styles_default = "/assets/styles-C-FkuI8b.css";
	...
	beforeLoad: async ({ location }) => {
		...
		if (session && location.pathname !== "/login") {
			...
			if (requiredPermission) {
				const { data: profile } = await supabase.from("profiles").select("roles(name, role_permissions(permissions(code)))").eq("id", session.user.id).single();
				const roleName = profile?.roles?.name;
				const permissions = profile?.roles?.role_permissions?.map((rp) => rp.permissions?.code) || [];
				if (!(roleName === "Administrateur" || Array.isArray(permissions) && permissions.includes(requiredPermission))) throw redirect({ to: "/" });
			}
		}
	},
	head: () => ({
...
var $$splitComponentImporter$13 = () => import("./ventes-DuCQHsE6.mjs");
...
var $$splitComponentImporter$12 = () => import("./utilisateurs-CeYWJYT9.mjs");
var Route$12 = createFileRoute("/utilisateurs")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./services-CrLSbLtT.mjs");
...
var $$splitComponentImporter$10 = () => import("./rapports-Dmavdsg0.mjs");
...
var $$splitComponentImporter$9 = () => import("./parametres-XMZws4pv.mjs");
...
var $$splitComponentImporter$8 = () => import("./login-DZZga_DJ.mjs");
objectType({
...
var $$splitComponentImporter$7 = () => import("./journal-zOEnpj2M.mjs");
var Route$7 = createFileRoute("/journal")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./fournisseurs-BebQBxYQ.mjs");
...
var $$splitComponentImporter$5 = () => import("./devis-CmiOULHX.mjs");
...
var $$splitComponentImporter$4 = () => import("./depenses-Drnm1VcB.mjs");
...
var $$splitComponentImporter$3 = () => import("./clients-DBj6PQr2.mjs");
...
var $$splitComponentImporter$2 = () => import("./achats-WwaI-ZR1.mjs");
...
var $$splitComponentImporter = () => import("./routes-BdvxHiEq.mjs");
