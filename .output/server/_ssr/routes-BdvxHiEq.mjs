...
import { Ct as ArrowUpRight, I as Package, R as Minus, W as LogIn, a as Users, b as ShoppingBag, bt as Building2, d as TrendingUp, dt as Clock, i as Wallet, j as Plus, k as Receipt, l as Truck, lt as CreditCard, r as Wrench, s as UserPlus, tt as FileText, w as Settings, wt as ArrowDownRight, y as ShoppingCart, yt as ChartColumn } from "../_libs/lucide-react.mjs";
import { t as supabase } from "./client-BJMeE8ke.mjs";
import { n as useQuery } from "../_libs/tanstack__react-query.mjs";
import { t as cn } from "./utils-C_uf36nf.mjs";
import { t as motion } from "../_libs/framer-motion.mjs";
import { t as AppShell } from "./AppShell-DPS6HqUC.mjs";
import { n as formatDate, r as formatDateTime, t as formatCurrency } from "./format-DujI6J5F.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BdvxHiEq.js
									...
									children: data.lists.ventes.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DashboardEmptyState, {
										...
										children: data.lists.ventes.map((v) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												className: "shrink-0 font-semibold text-sm",
												children: formatCurrency(Number(v.total))
											})]
										}) }, v.id))
									})
								}),
									...
									children: data.lists.achats.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DashboardEmptyState, {
										...
										children: data.lists.achats.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												className: "shrink-0 font-semibold text-sm",
												children: formatCurrency(Number(a.total))
											})]
										}) }, a.id))
									})
								}),
									...
									children: data.lists.depenses.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DashboardEmptyState, {
										...
										children: data.lists.depenses.map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												className: "shrink-0 font-semibold text-sm",
												children: formatCurrency(Number(d.amount))
											})]
										}) }, d.id))
									})
								}),
