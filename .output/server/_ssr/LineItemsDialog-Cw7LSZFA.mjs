...
//#region node_modules/.nitro/vite/services/ssr/assets/LineItemsDialog-Cw7LSZFA.js
...
function LineItemsDialog(props) {
	...
	const saveMut = useMutation({
		mutationFn: async () => {
			if (headerTable === "ventes" && isEdit && !canManageSales) throw new Error("Accès refusé");
