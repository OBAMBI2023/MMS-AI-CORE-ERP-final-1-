  ...
  public: {
    Tables: {
      ...
      hotel_settings: {
        Row: {
          ...
          show_signature_on_documents: boolean
          show_stamp_on_documents: boolean
          tax_rate: number
          tenant_id: string
          timezone: string
          updated_at: string
    ...
    Functions: {
      ...
      create_support_ticket: {
        Args: {
          requested_attachment_name?: string
          requested_attachment_path?: string
      ...
      get_dashboard_monthly_series: {
        Args: { p_month_ends: string[]; p_month_starts: string[] }
        Returns: {
          achats: number
          ca: number
          depenses: number
      ...
      get_dashboard_weekly_trend: {
        Args: { p_week_ends: string[]; p_week_starts: string[] }
        Returns: {
          achats: number
          benefice: number
      ...
      get_distinct_ventes_payment_methods: {
        Args: never
        Returns: {
          payment_method: string
        }[]
      }
      get_fournisseur_achats_stats: {
        Args: never
        Returns: {
          achats_count: number
      ...
      get_ventes_performance_by_period: {
