...
import { Users, Truck, Briefcase, Receipt, ShoppingCart, CreditCard, FileText, Settings, Loader2, Clock } from "lucide-react";
...
export function GlobalSearch({
  ...
  const groupedResults = useMemo(() => {
    return results.reduce((acc, result) => {
      ...
      const module = (result.module.charAt(0).toUpperCase() + result.module.slice(1).toLowerCase()) as SearchModule;
      if (!acc[module]) {
        acc[module] = [];
      }
