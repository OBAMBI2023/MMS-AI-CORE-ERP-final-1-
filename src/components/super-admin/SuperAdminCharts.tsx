...
export function SuperAdminCharts({ dashboard }: { dashboard: SuperAdminDashboard }) {
  ...
  return (
    <section id="rapports" className="scroll-mt-24 space-y-4">
      ...
      <ChartCard title="Ventes par tenant" subtitle="CA cumulé des principaux tenants">
        <div className="h-72">
          {salesByTenant.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={salesByTenant} layout="vertical" margin={{ left: -8, right: 24 }}>
